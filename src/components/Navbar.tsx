      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/contact" className="text-gray-700 hover:text-[#C5BAFF]">Contact</Link>
            <button className="bg-[#C5BAFF] text-white px-4 py-2 rounded-lg hover:bg-opacity-90">
              Get Started
            </button>
          </div>
        ...
        {isOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <button className="w-full bg-[#C5BAFF] text-white px-4 py-2 rounded-lg hover:bg-opacity-90">
                Get Started
              </button>
            </div>
          </div>
